...
class Board(button):
    ...
    def check_draw(self):
        if self.isfull():
            self.button(self.gd, black, 90, 250, 400, 100, 'cambriacambriamath', 60, 'GAME DRAW ', white, 110, 280)
...
class single_player():
    ...
    def main(self):
        ...
        while (over == True):
            ...
            if seconds >= 11 and not game.isover() and len(board.get_empty_sqrs()) != 0:
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if 150 < pos[0] < 450 and 150 < pos[1] < 450:
                        ...
                        if board.empty_sqr(row, col):
                            ...
                            if game.isover() and seconds <= 11:
                                board.button(gd, black, 230, 80, 120, 30, 'cambriacambriamath', 40, "You won", white,
                                             230, 80)
                                ...
                                window5 = pygame.image.load('restart.jpeg')
                                gd.blit(window5, (300, 510))
                            elif seconds > 11 and not game.isover():
                                board.button(gd, black, 90, 250, 400, 100, 'cambriacambriamath', 60, 'TIME OVER ',
                                             white, 150, 280)
                                window4 = pygame.image.load('home.jpeg')
                                gd.blit(window4, (140, 510))
                                window5 = pygame.image.load('restart.jpeg')
                                gd.blit(window5, (300, 510))
                            elif len(board.get_empty_sqrs()) == 0 and board.final_state() == 0 and seconds <= 11:
                                board.button(gd, black, 90, 250, 400, 100, 'cambriacambriamath', 60, 'GAME DRAW ',
                                             white, 150, 280)
                                board.button(gd, black, 230, 80, 120, 40, 'cambriacambriamath', 40, "Draw!", white, 250,
                                             80)
                                window4 = pygame.image.load('home.jpeg')
                                gd.blit(window4, (140, 510))
                                window5 = pygame.image.load('restart.jpeg')
...
class multiplayer:
    ...
    def main(self):
        ...
        while (over == True):
            ...
            if seconds <= 11 and board.final_state() == 0 and board.isfull():
                board.button(gd, black, 230, 80, 120, 40, 'cambriacambriamath', 40, "Draw!", white, 250, 80)

            if seconds > 11 and not game.isover():
                board.button(gd, black, 90, 250, 400, 100, 'cambriacambriamath', 60, 'TIME OVER ', white, 150, 280)
                window4 = pygame.image.load('home.jpeg')
                gd.blit(window4, (140, 510))
                window5 = pygame.image.load('restart.jpeg')
...
class exit_screen(button):
    ...
    def __init__(self):
        ...
        self.heading(self.screen, "freesansbold.ttf", 20, 'ARE YOU SURE YOU WANT TO EXIT ?', black, 280)
        ...
        while (game == True):
            ...
            for event in pygame.event.get():
                ...
                if 225 < mouse[0] < 200 + 200 and 300 < mouse[1] < 300 + 55:
                    ...
                    self.button(self.screen, (128, 0, 128), 225, 300, 150, 55, 'cambriacambriamath', 30, 'YES', white,
                                280, 310)
                ...
                if 225 < mouse[0] < 200 + 200 and 400 < mouse[1] < 400 + 55:
                    ...
                    self.button(self.screen, (128, 0, 128), 225, 400, 150, 55, 'cambriacambriamath', 30, 'NO', white,
                                280, 410)
